...
class PageUsuarios extends Component {
  ...
  peticionPut = () => {
    console.log(url+'/'+fieldid+'/'+this.state.form.usu_id)
    axios.put(url+'/'+fieldid+'/'+this.state.form.usu_id, this.state.form)
      .then((response) => {
        this.modalInsertar() //cerramos la modal form
        this.peticionGet()
      })
  ...
  peticionDelete = () => {
    console.log(url+'/'+fieldid+'/'+this.state.form.usu_id)
    axios.delete(url+'/'+fieldid+'/'+this.state.form.usu_id, this.state.form)
      .then((response) => {
